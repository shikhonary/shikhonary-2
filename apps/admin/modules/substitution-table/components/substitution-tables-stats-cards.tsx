...
import { TableProperties, BarChart2 } from "lucide-react"

interface SubstitutionTablesStatsCardsProps {
  totalCount?: number
  difficultyCounts?: {
    EASY: number
    MEDIUM: number
...
export function SubstitutionTablesStatsCards({
  totalCount = 0,
  difficultyCounts = { EASY: 0, MEDIUM: 0, HARD: 0 },
  isLoading = false,
}: SubstitutionTablesStatsCardsProps) {
  if (isLoading) {
    return (
      <div className="mb-6">
