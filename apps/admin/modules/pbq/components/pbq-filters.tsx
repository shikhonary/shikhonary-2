  ...
  const getSortLabel = (sort: string) => {
    switch (sort) {
      ...
      case "oldest":
        return "Oldest First"
      case "context_asc":
        return "Context (A to Z)"
      case "context_desc":
        return "Context (Z to A)"
      default:
        return "Default Sort"
    }
  }
      ...
      <div className={isMobile ? "space-y-1.5" : "min-w-[160px] flex-1 md:flex-none"}>
        ...
        >
          ...
          <SelectContent className="bg-white border border-outline-variant shadow-md rounded-lg">
            ...
            <SelectItem value="context_asc">Context (A to Z)</SelectItem>
            <SelectItem value="context_desc">Context (Z to A)</SelectItem>
          </SelectContent>
        </Select>
      </div>
    </>
    ...
    <div className="mb-6 space-y-3">
      ...
      <div className="flex items-center gap-3 rounded-xl border border-outline-variant/30 bg-surface-container-low p-3 sm:p-4">
        ...
        <div className="relative flex-1 min-w-0">
          ...
          <Input
            type="text"
            placeholder="Search questions, context/passage, source, or references..."
            value={searchQuery}
          ...
          <DrawerContent className="p-6 space-y-5 bg-white border-t border-outline-variant/40 max-h-[90vh] overflow-y-auto">
            <DrawerHeader className="p-0 text-left">
              ...
              <DrawerDescription className="text-xs text-on-surface-variant">
                Select filters, sorting, and page options to refine PBQ records.
              </DrawerDescription>
            </DrawerHeader>
