        ...
        <div className="flex items-center gap-4 rounded-xl border border-outline-variant/30 bg-surface-container-low p-4 transition-all hover:shadow-sm">
          ...
          <div className="w-full">
            ...
            <div className="mt-1 flex items-center justify-between text-xs">
              <span className="text-emerald-700 font-medium">Easy: {difficultyCounts?.EASY ?? 0}</span>
              <span className="text-blue-700 font-medium">Med: {difficultyCounts?.MEDIUM ?? 0}</span>
              <span className="text-rose-700 font-medium">Hard: {difficultyCounts?.HARD ?? 0}</span>
            </div>
