...
export function OppositeWordListHeader() {
  return (
    <section className="mb-6 sm:mb-8 flex flex-col justify-between gap-4 sm:gap-6 md:flex-row md:items-end">
      <div>
        ...
        <p className="max-w-2xl font-body-md text-xs sm:text-sm md:text-base leading-relaxed text-on-surface-variant">
          Manage chapter-based opposite words (বিপরীত শব্দ), alternative antonyms, reference boards, and difficulty levels across classes, subjects, and chapters.
        </p>
      </div>
      <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
        ...
        >
          <Link href="/opposite-words/import">
        ...
        >
          <Link href="/opposite-words/create">
            ...
            <span className="relative z-10">Add New Opposite Word</span>
          </Link>
        </Button>
      </div>
    </section>
