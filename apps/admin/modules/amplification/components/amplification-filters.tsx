...
interface AmplificationFiltersProps {
  searchQuery: string
...
export function AmplificationFilters({
  searchQuery,
  onSearchChange,
    ...
    <div className="mb-6 space-y-3">
      ...
      <div className="flex items-center gap-3 rounded-xl border border-outline-variant/30 bg-surface-container-low p-3 sm:p-4">
        ...
        <div className="relative flex-1 min-w-0">
          ...
          <Input
            type="text"
            placeholder="Search amplifications, references..."
            value={searchQuery}
          ...
          <DrawerContent className="p-6 space-y-5 bg-white border-t border-outline-variant/40 max-h-[90vh] overflow-y-auto">
            <DrawerHeader className="p-0 text-left">
              ...
              <DrawerDescription className="text-xs text-on-surface-variant">
                Select filters, sorting, and page options to refine amplification records.
              </DrawerDescription>
            </DrawerHeader>
