...
interface NewsReportStatsCardsProps {
  totalCount?: number
  difficultyCounts?: {
    EASY: number
    MEDIUM: number
...
export function NewsReportStatsCards({
  totalCount = 0,
  difficultyCounts = { EASY: 0, MEDIUM: 0, HARD: 0 },
  isLoading = false,
}: NewsReportStatsCardsProps) {
  if (isLoading) {
    return (
      <div className="mb-6">
