...
import { useCreateRole } from "../services/use-role"
...
export function CreateRoleModal() {
  const { isOpen, closeModal } = useCreateRoleModalStore()
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-outline mt-0.5">
              Define a new system role and access configurations
            </p>
          </div>
        </div>
        ...
        <DialogHeader className="pt-1">
          <DialogDescription className="font-body-md text-sm leading-relaxed text-on-surface-variant">
            Specify the naming convention and a concise description of the privileges that this role encapsulates.
          </DialogDescription>
        </DialogHeader>
