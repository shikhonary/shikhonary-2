...
export function SummaryListHeader() {
  return (
    <section className="mb-6 sm:mb-8 flex flex-col justify-between gap-4 sm:gap-6 md:flex-row md:items-end">
      <div>
        ...
        <p className="max-w-2xl font-body-md text-xs sm:text-sm md:text-base leading-relaxed text-on-surface-variant">
          Manage passage summaries, précis prompts, সারসংক্ষেপ ও সারমর্ম, reference citations, difficulty levels, and associations across classes and subjects.
        </p>
      </div>
      <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
        ...
        >
          <Link href="/summaries/create">
            ...
            <span className="relative z-10">Add New Summary</span>
          </Link>
        </Button>
      </div>
    </section>
