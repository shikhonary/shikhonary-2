...
export const NewsReportBlock = ({ item }: { item: any }) => {
  ...
  const isFirst = item.isFirstNewsReport !== undefined ? item.isFirstNewsReport : (item.orderIndex === 0);
  ...
  return (
    <div className={`group relative -mx-4 px-4 hover:bg-muted/10 rounded-lg transition-colors flex flex-col break-inside-avoid ${isFirst ? "pt-0.5 pb-0" : "py-0 my-0"}`}>
        ...
        <div className="flex justify-between items-start w-full">
          ...
          >
            ...
            <EditableSectionLabel
              ...
              fallbackLabel="যেকোনো একটি বিষয়ে সংবাদ প্রতিবেদন রচনা করো:"
              questionType="NEWS_REPORT"
              style={{
                fontSize: questionStyle.fontSize,
                fontFamily: questionStyle.fontFamily,
      ...
      <AddAlternativeModal
        ...
        primaryQuestionType="NEWS_REPORT"
