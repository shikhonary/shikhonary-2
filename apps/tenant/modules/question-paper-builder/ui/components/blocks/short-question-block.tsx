...
const ShortQuestionEditableText = ({ 
  text, 
  itemKey, 
  defaultStyle,
  className = ""
...
export const ShortQuestionBlock = ({ item }: { item: any }) => {
  ...
  return (
    <div className={`group relative -mx-4 px-4 hover:bg-muted/10 rounded-lg transition-colors flex flex-col break-inside-avoid ${item.isFirstShortQuestion ? "pt-0.5 pb-0" : "py-0 my-0"}`}>
      {/* Hover Controls */}
        ...
        <div className="flex justify-between items-start w-full mb-1">
          ...
          >
            ...
            <EditableSectionLabel
              ...
              fallbackLabel="নিচের প্রশ্নগুলোর সংক্ষেপে উত্তর দাও:"
              questionType="SHORT_QUESTION"
      ...
      <AddAlternativeModal
        ...
        primaryQuestionType="SHORT_QUESTION"
