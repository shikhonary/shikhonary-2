...
type CreateQuestionTypeFormData = z.infer<typeof createQuestionTypeFormSchema>

export function CreateQuestionTypeView() {
  ...
  } = useForm<CreateQuestionTypeFormData>({
    resolver: zodResolver(createQuestionTypeFormSchema),
    defaultValues: {
      nameEn: "",
      nameBn: "",
      label: "",
  ...
  const onSubmit = async (data: CreateQuestionTypeFormData) => {
    ...
    try {
      ...
      const msg = err.message || "Failed to create question type"
      setErrorMessage(msg)
      toast.error(msg)
    }
  }
      ...
      <div className="mb-6 sm:mb-10 flex flex-col gap-4 md:flex-row md:items-end justify-between">
        <div className="max-w-2xl">
          ...
          <p className="font-body-md text-xs sm:text-sm text-on-surface-variant leading-relaxed">
            Configure question type titles, marks, position levels, and status templates.
          </p>
        </div>
      </div>
