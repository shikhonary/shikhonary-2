...
interface GenderChangeStatsCardsProps {
  totalCount?: number
  difficultyCounts?: {
    EASY: number
    MEDIUM: number
...
export function GenderChangeStatsCards({
  totalCount = 0,
  difficultyCounts = { EASY: 0, MEDIUM: 0, HARD: 0 },
  isLoading = false,
}: GenderChangeStatsCardsProps) {
  if (isLoading) {
    return (
      <div className="mb-6">
