...
export function FillInTheBlanksWithCluesListHeader() {
  return (
    <section className="mb-6 sm:mb-8 flex flex-col justify-between gap-4 sm:gap-6 md:flex-row md:items-end">
      <div>
        ...
        <p className="max-w-2xl font-body-md text-xs sm:text-sm md:text-base leading-relaxed text-on-surface-variant">
          Manage cloze tests / words from the box questions with clue boxes, passage gaps, reference tags, difficulty levels, and academic associations.
        </p>
      </div>
      <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
        ...
        >
          <Link href="/fill-in-the-blanks-with-clues/import">
        ...
        >
          <Link href="/fill-in-the-blanks-with-clues/create">
