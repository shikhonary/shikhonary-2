...
export const PoemBlock = ({ item }: { item: any }) => {
  ...
  const isFirst = item.isFirstPoem !== undefined ? item.isFirstPoem : (item.orderIndex === 0);
        ...
        <div className="flex gap-1 flex-1 relative flex-col">
          <div className="flex gap-2 items-start w-full">
            ...
            <div className="flex-1 w-full min-w-0">
              ...
              >
                <RenderMath text={`কবি ও কবিতার নামসহ ${data.title || data.name || ""} কবিতাটি লেখো।`} />
              </span>
            </div>
