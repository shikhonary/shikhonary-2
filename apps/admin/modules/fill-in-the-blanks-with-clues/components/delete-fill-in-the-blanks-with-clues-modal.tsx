...
import { useDeleteFillInTheBlanksWithClues, useBulkDeleteFillInTheBlanksWithClues } from "../services/use-fill-in-the-blanks-with-clues"
import { useDeleteFillInTheBlanksWithCluesModalStore } from "../store/use-delete-fill-in-the-blanks-with-clues-modal-store"

export function DeleteFillInTheBlanksWithCluesModal() {
  const { isOpen, fillInTheBlanksId, fillInTheBlanksContent, selectedIds, closeModal } =
    useDeleteFillInTheBlanksWithCluesModalStore()

  const [isDeleting, setIsDeleting] = useState(false)
  const deleteMutation = useDeleteFillInTheBlanksWithClues()
  const bulkDeleteMutation = useBulkDeleteFillInTheBlanksWithClues()
