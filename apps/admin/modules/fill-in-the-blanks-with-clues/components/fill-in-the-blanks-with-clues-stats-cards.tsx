...
interface FillInTheBlanksWithCluesStatsCardsProps {
  totalCount?: number
  difficultyCounts?: {
    EASY: number
    MEDIUM: number
...
export function FillInTheBlanksWithCluesStatsCards({
  totalCount = 0,
  difficultyCounts = { EASY: 0, MEDIUM: 0, HARD: 0 },
  isLoading = false,
}: FillInTheBlanksWithCluesStatsCardsProps) {
  if (isLoading) {
    return (
      <div className="mb-6">
