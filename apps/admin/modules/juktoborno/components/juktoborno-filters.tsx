...
interface JuktobornoFiltersProps {
  searchQuery: string
...
export function JuktobornoFilters({
  searchQuery,
  onSearchChange,
  ...
  const getSortLabel = (sort: string) => {
    switch (sort) {
      ...
      case "oldest":
        return "Oldest First"
      case "juktoborno_asc":
        return "Juktoborno (A to Z)"
      case "juktoborno_desc":
        return "Juktoborno (Z to A)"
      case "popularity":
        return "Most Popular"
      default:
        return "Default Sort"
      ...
      <div className={isMobile ? "space-y-1.5" : "min-w-[160px] flex-1 md:flex-none"}>
        ...
        >
          ...
          <SelectContent className="bg-white border border-outline-variant shadow-md rounded-lg">
            ...
            <SelectItem value="juktoborno_asc">Juktoborno (A to Z)</SelectItem>
            <SelectItem value="juktoborno_desc">Juktoborno (Z to A)</SelectItem>
    ...
    <div className="mb-6 space-y-3">
      ...
      <div className="flex items-center gap-3 rounded-xl border border-outline-variant/30 bg-surface-container-low p-3 sm:p-4">
        ...
        <div className="relative flex-1 min-w-0">
          ...
          <Input
            type="text"
            placeholder="Search juktoborno, reference..."
            value={searchQuery}
          ...
          <DrawerContent className="p-6 space-y-5 bg-white border-t border-outline-variant/40 max-h-[90vh] overflow-y-auto">
            <DrawerHeader className="p-0 text-left">
              <DrawerTitle className="text-base font-bold text-on-surface flex items-center gap-2">
                ...
                Filter Juktoborno Items
              </DrawerTitle>
              <DrawerDescription className="text-xs text-on-surface-variant">
                Select filters and sorting options to refine juktoborno list.
              </DrawerDescription>
            </DrawerHeader>
