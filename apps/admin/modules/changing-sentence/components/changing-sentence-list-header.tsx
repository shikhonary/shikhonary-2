...
export function ChangingSentenceListHeader() {
  return (
    <section className="mb-6 sm:mb-8 flex flex-col justify-between gap-4 sm:gap-6 md:flex-row md:items-end">
      <div>
        <h2 className="mb-1 font-headline-md text-2xl sm:text-3xl font-extrabold text-primary md:text-4xl">
          Changing Sentences Question Bank
        </h2>
        <p className="max-w-2xl font-body-md text-xs sm:text-sm md:text-base leading-relaxed text-on-surface-variant">
          Manage Changing Sentences (Transformation of Sentences) questions with bracketed directives, options, board references, difficulty levels, and academic subject associations.
        </p>
      </div>
      <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
        ...
        >
          <Link href="/changing-sentences/import">
        ...
        >
          <Link href="/changing-sentences/create">
