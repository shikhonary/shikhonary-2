...
interface FillInTheBlanksWithCluesFiltersProps {
  searchQuery: string
...
export function FillInTheBlanksWithCluesFilters({
  searchQuery,
  onSearchChange,
  ...
  selectedSort,
  onSortChange,
}: FillInTheBlanksWithCluesFiltersProps) {
    ...
    <div className="mb-6 space-y-3">
      ...
      <div className="flex items-center gap-3 rounded-xl border border-outline-variant/30 bg-surface-container-low p-3 sm:p-4">
        ...
        <div className="relative flex-1 min-w-0">
          ...
          <Input
            type="text"
            placeholder="Search questions, clues, references..."
            value={searchQuery}
