...
export function QuestionTypeListHeader() {
  return (
    <section className="mb-6 sm:mb-8 flex flex-col justify-between gap-4 sm:gap-6 md:flex-row md:items-end">
      <div>
        ...
        <p className="max-w-2xl font-body-md text-xs sm:text-sm md:text-base leading-relaxed text-on-surface-variant">
          Manage system question types, default marks, positions, and translation labels.
        </p>
      </div>
      <Link href="/question-types/create" passHref className="w-full sm:w-auto">
        <Button
        ...
        >
          ...
          <span className="relative z-10">Add Question Type</span>
        </Button>
      </Link>
    </section>
  )
