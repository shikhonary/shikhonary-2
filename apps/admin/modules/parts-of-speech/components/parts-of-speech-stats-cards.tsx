...
interface PartsOfSpeechStatsCardsProps {
  totalCount?: number
  difficultyCounts?: {
    EASY: number
    MEDIUM: number
...
export function PartsOfSpeechStatsCards({
  totalCount = 0,
  difficultyCounts = { EASY: 0, MEDIUM: 0, HARD: 0 },
  isLoading = false,
}: PartsOfSpeechStatsCardsProps) {
  if (isLoading) {
    return (
      <div className="mb-6">
