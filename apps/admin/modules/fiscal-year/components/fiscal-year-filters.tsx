...
interface FiscalYearFiltersProps {
  searchQuery: string
...
export function FiscalYearFilters({
  ...
  const getSortLabel = (sort: string) => {
    switch (sort) {
      ...
      case "newest":
        return "Newest Start Date"
      case "oldest":
        return "Oldest Start Date"
      default:
        return sort
    }
  }
      ...
      <div className={isMobile ? "space-y-1.5" : "min-w-[180px]"}>
        ...
        >
          ...
          <SelectContent className="bg-white border border-outline-variant shadow-md rounded-lg">
            ...
            <SelectItem value="name_asc">Year (Ascending)</SelectItem>
            <SelectItem value="name_desc">Year (Descending)</SelectItem>
    ...
    <div className="mb-6 space-y-3">
      ...
      <div className="flex items-center gap-3 rounded-xl border border-outline-variant/30 bg-surface-container-low p-3 sm:p-4">
        ...
        <div className="relative flex-1 min-w-0">
          ...
          <Input
            type="text"
            placeholder="Filter by Fiscal Year Label..."
            value={searchQuery}
          ...
          <DrawerContent className="p-6 space-y-5 bg-white border-t border-outline-variant/40">
            <DrawerHeader className="p-0 text-left">
              ...
              <DrawerDescription className="text-xs text-on-surface-variant">
                Select sorting options to refine fiscal year records.
              </DrawerDescription>
            </DrawerHeader>
