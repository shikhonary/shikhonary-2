...
import { useToggleCsActive } from "../services/use-cs"
...
export function CsTable({
  ...
  const toggleActiveMutation = useToggleCsActive()
  ...
  const handleToggleActive = async (id: string, currentActive: boolean) => {
    try {
      ...
      toast.success(!currentActive ? "CS activated." : "CS deactivated.")
    } catch (err: any) {
      toast.error(err.message || "Failed to update CS status")
    }
  }
      ...
      {isLoading && (
        <div className="py-16 text-center text-on-surface-variant rounded-xl border border-outline-variant bg-white">
          <div className="flex flex-col items-center justify-center gap-3">
            ...
            <span className="font-body-md text-sm font-medium">Loading CS question bank...</span>
          </div>
        </div>
      )}
        ...
        <div className="py-16 text-center text-error rounded-xl border border-error/30 bg-error-container/20">
          <div className="flex flex-col items-center justify-center gap-3">
            ...
            <span className="font-body-md text-sm font-medium">
              Error loading CS questions. Please try refreshing.
            </span>
          </div>
        </div>
      )}
        ...
        <div className="py-16 text-center text-on-surface-variant rounded-xl border border-outline-variant bg-white">
          <div className="flex flex-col items-center justify-center gap-3">
            ...
            <p className="font-body-md text-sm text-outline max-w-md">
              Try adjusting filters or add a new creative scenario question to the bank.
            </p>
          </div>
        </div>
      )}
