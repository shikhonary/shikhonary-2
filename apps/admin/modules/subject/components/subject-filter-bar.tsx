...
import { X, RotateCcw, SlidersHorizontal, ArrowUpDown, Calendar, GraduationCap } from "lucide-react"
import { useAcademicYearsForSelection, useAcademicClassesForSelection } from "../services/use-subject"
...
export function SubjectFilterBar({
  ...
  const hasAnyFilter = hasActiveQuery || hasActiveSort || hasActiveYear || hasActiveClass

  const activeFilterCount = (hasActiveSort ? 1 : 0) + (hasActiveYear ? 1 : 0) + (hasActiveClass ? 1 : 0)
  ...
  const renderSelectFilters = (isMobile = false) => (
    <>
      ...
      <div className={isMobile ? "space-y-1.5" : "min-w-[200px]"}>
        {isMobile && (
      ...
      <div className={isMobile ? "space-y-1.5" : "min-w-[180px]"}>
        ...
        >
          ...
          <SelectContent className="bg-white border border-outline-variant shadow-md rounded-lg">
            ...
            <SelectItem value="code_asc">Code (Ascending)</SelectItem>
            <SelectItem value="code_desc">Code (Descending)</SelectItem>
          </SelectContent>
        </Select>
      </div>
    </>
    ...
    <div className="mb-6 space-y-3">
      ...
      <div className="flex items-center gap-3 rounded-xl border border-outline-variant/30 bg-surface-container-low p-3 sm:p-4">
        ...
        <div className="relative flex-1 min-w-0">
          ...
          <Input
            type="text"
            placeholder="Filter by Subject Name, Code or Syllabus Group..."
            value={searchQuery}
          ...
          <DrawerContent className="p-6 space-y-5 bg-white border-t border-outline-variant/40">
            <DrawerHeader className="p-0 text-left">
              ...
              <DrawerDescription className="text-xs text-on-surface-variant">
                Select configurations to filter and order subject syllabus data.
              </DrawerDescription>
            </DrawerHeader>
