...
import { useDeleteSubscriptionPlan } from "../services/use-subscription-plan"
...
export function DeleteSubscriptionPlanModal() {
  const { isOpen, planId, planName, closeModal } =
    useDeleteSubscriptionPlanModalStore()
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      toast.success(
        `Subscription plan "${planName || "Plan"}" deleted successfully.`
      )
      closeModal()
    } catch (err: any) {
