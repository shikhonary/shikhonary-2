              ...
              <TableBody className="divide-y divide-outline-variant/30">
                {items.map((item) => {
                  ...
                  return (
                    ...
                    >
                      {/* Exam Info (Title, Type, Class, Group, Attempts, Subjects) */}
                          ...
                          <div className="flex flex-wrap items-center gap-1.5 mt-1.5">
                            ...
                            {firstGroup && (
                              <Link
                                ...
                                className="inline-flex items-center gap-1 rounded-md bg-indigo-50 px-2 py-0.5 font-label-sm text-[10px] font-bold text-indigo-700 hover:bg-indigo-100 transition-colors border border-indigo-200"
