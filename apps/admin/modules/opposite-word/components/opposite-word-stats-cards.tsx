...
interface OppositeWordStatsCardsProps {
  totalCount?: number
  difficultyCounts?: {
    EASY: number
    MEDIUM: number
...
export function OppositeWordStatsCards({
  totalCount = 0,
  difficultyCounts = { EASY: 0, MEDIUM: 0, HARD: 0 },
  isLoading = false,
}: OppositeWordStatsCardsProps) {
  if (isLoading) {
    return (
      <div className="mb-6">
    ...
    <div className="mb-6">
      ...
      <div className="flex flex-wrap items-center gap-2 sm:hidden">
        <Badge variant="outline" className="rounded-md border-primary/20 bg-primary/10 px-3 py-1.5 text-xs font-bold text-primary normal-case tracking-normal">
          Total Opposite Words: {totalCount ?? 0}
        </Badge>
