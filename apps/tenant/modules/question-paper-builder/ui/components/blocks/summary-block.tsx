...
export const SummaryBlock = ({ item }: { item: any }) => {
  ...
  const isFirst = item.isFirstSummary !== undefined ? item.isFirstSummary : (item.orderIndex === 0);
