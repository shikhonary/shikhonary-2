...
export function DeleteSubjectModal() {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      toast.success(
        `Subject "${subjectName || "Subject"}" deleted successfully.`
      )
      closeModal()
    } catch (err: any) {
      ...
      >
        ...
        <DialogHeader className="pt-1">
          <DialogDescription className="font-body-md text-sm leading-relaxed text-on-surface-variant">
            ...
            ? All chapters, curriculum records, and academic class mappings will be permanently removed.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex items-start gap-2.5 rounded-xl border border-red-500/20 bg-red-500/5 p-3 text-xs text-red-700">
          ...
          <p className="leading-snug">
            This action cannot be undone. Associated chapters and curriculum dependencies will be affected.
          </p>
        </div>
