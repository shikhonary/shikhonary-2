...
interface ShortCompositionStatsCardsProps {
  totalCount?: number
  difficultyCounts?: {
    EASY: number
    MEDIUM: number
...
export function ShortCompositionStatsCards({
  totalCount = 0,
  difficultyCounts = { EASY: 0, MEDIUM: 0, HARD: 0 },
  isLoading = false,
}: ShortCompositionStatsCardsProps) {
  if (isLoading) {
    return (
      <div className="mb-6">
