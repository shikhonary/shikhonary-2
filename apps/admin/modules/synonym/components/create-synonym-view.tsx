...
const createSynonymFormSchema = z.object({
...
type CreateSynonymFormData = z.infer<typeof createSynonymFormSchema>

export function CreateSynonymView() {
  ...
  } = useForm<CreateSynonymFormData>({
    resolver: zodResolver(createSynonymFormSchema),
    defaultValues: {
      classId: "",
      subjectId: "",
      chapterId: "",
  ...
  const onSubmit = async (data: CreateSynonymFormData) => {
    ...
    try {
      ...
      // If synonymWord is provided and not in synonymsArray, include it or keep it as primary synonymWord
      ...
      toast.success("Synonym entry created successfully.")
      setTimeout(() => {
        router.push("/synonyms")
      }, 1000)
    } catch (err: any) {
      const msg = err.message || "Failed to create synonym entry"
      setErrorMessage(msg)
      toast.error(msg)
    }
  }
    ...
    <div className="w-full max-w-4xl mx-auto">
      ...
      <div className="mb-10 flex flex-col gap-6 md:flex-row md:items-end justify-between">
        <div className="max-w-2xl">
          ...
          <p className="font-body-md text-on-surface-variant leading-relaxed text-sm">
            Add a new word and its synonyms (সমার্থক শব্দ) to the question bank.
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          <CardContent className="p-0 space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  {...register("word")}
                  placeholder="Enter main word (e.g. সমুদ্র, পানি, সূর্য)..."
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Enter primary synonym (e.g. সাগর, জল, রবি)..."
                  className="bg-white font-solaiman text-base font-semibold"
                />
              </div>
            </div>
        ...
        <div className="flex items-center justify-end gap-3 pt-4">
          ...
          >
            {isSubmitting ? "Creating..." : "Save Synonym Entry"}
          </Button>
        </div>
      </form>
    </div>
