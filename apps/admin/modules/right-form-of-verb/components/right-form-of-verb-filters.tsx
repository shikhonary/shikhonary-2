...
interface RightFormOfVerbFiltersProps {
  searchQuery: string
...
export function RightFormOfVerbFilters({
  searchQuery,
  onSearchChange,
  ...
  const hasActiveFilters = hasActiveQuery || hasActiveSubject || hasActiveDifficulty || hasActiveSort
  ...
  const activeFilterCount = [
    hasActiveQuery,
    selectedAcademicClassId && selectedAcademicClassId !== "All",
    hasActiveSubject,
    hasActiveDifficulty,
    hasActiveSort,
    ...
    <div className="mb-6 space-y-4">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
        ...
        <div className="relative flex-1">
          <Input
            placeholder="Search questions or reference..."
            value={searchQuery}
        ...
        <div className="hidden md:flex items-center gap-2.5 flex-wrap">
          ...
          {hasActiveFilters && (
            <Button
              ...
              size="sm"
              onClick={handleReset}
              className="text-xs text-outline hover:text-on-surface flex items-center gap-1 h-9 px-2.5"
            >
