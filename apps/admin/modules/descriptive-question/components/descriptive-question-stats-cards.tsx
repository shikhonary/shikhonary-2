...
interface DescriptiveQuestionStatsCardsProps {
  totalCount?: number
  difficultyCounts?: {
    EASY: number
    MEDIUM: number
...
export function DescriptiveQuestionStatsCards({
  totalCount = 0,
  difficultyCounts = { EASY: 0, MEDIUM: 0, HARD: 0 },
  isLoading = false,
}: DescriptiveQuestionStatsCardsProps) {
  if (isLoading) {
    return (
      <div className="mb-6">
